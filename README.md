## Hi there 👋
#### I am **Farid**. I am a web developer use REACTJS and NODEJS.
...
## ⚡These are just some hooks I developed for REACTJS
...
## :man_mechanic:Current **side project** I’m working on it:
### Board broadcaster:
It is just a fun project that a presenter can use to draw some shapes on a board and participant get them at the time.
- React app: [repo](https://github.com/faridEsnaashari/boardBroadcaster)
- API: [repo](https://github.com/faridEsnaashari/boardBroadcaster_api)
